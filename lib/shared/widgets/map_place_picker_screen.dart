...
class MapPlacePickerScreen extends ConsumerStatefulWidget {
  const MapPlacePickerScreen({
    super.key,
    required this.args,
    this.onPickedForTest,
  });

  final MapPlacePickerArgs args;
  final void Function(MapPlace place)? onPickedForTest;

  @override
  ConsumerState<MapPlacePickerScreen> createState() =>
      _MapPlacePickerScreenState();
}

class _MapPlacePickerScreenState extends ConsumerState<MapPlacePickerScreen>
