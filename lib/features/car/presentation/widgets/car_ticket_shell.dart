...
/// Boarding-pass [OutlinedBorder] for private-car cards — notches + dashed
/// tear. Independent of bus [TicketBorder]; do not import from `bus/`.
class CarTicketBorder extends OutlinedBorder {
  const CarTicketBorder({
    this.radius = 20,
    this.notchRadius = 10,
  ...
  @override
  ShapeBorder scale(double t) => CarTicketBorder(
        side: side.scale(t),
        radius: radius * t,
  ...
  bool operator ==(Object other) {
    ...
    return other is CarTicketBorder &&
        other.side == side &&
        other.radius == radius &&
